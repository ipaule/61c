...
{
		ComplexNumber* num = (ComplexNumber* )malloc(sizeof(ComplexNumber));
		num->real = real_component;
		num->imaginary = imaginary_component;
		return num;
}
...
ComplexNumber* ComplexProduct(ComplexNumber* a, ComplexNumber* b)
{
    //YOUR CODE HERE
		ComplexNumber* num = (ComplexNumber* )malloc(sizeof(ComplexNumber));
		num->real = a->real * b->real - a->imaginary * b->imaginary;
		num->imaginary = a->real * b->imaginary + b->real * a->imaginary;
		return num;
}
